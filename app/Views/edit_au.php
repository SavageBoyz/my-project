<!--
*
* Редактирование информации о контр. органах
*
-->
...
<section>
  <div class="container">
    <form class="row g-3" action="/authority/edit_validation/<?=$authority['Id_au']?>" method="post">
    <!-- 1 --->
    <div class="form-group col-md-4">
      ...
      value= '<?= $authority['TitleA']; ?>' required>
    </div>
    <!-- Кнопка submit -->
