<!--
*
* Добавление информации о контр. органах
*
-->
...
<section>
  <div class="container">
    <form class="row g-3" action="/authority/create" method="post">
    <!-- 1 --->
    <div class="form-group col-md-3">
        <label for="title" class="form-label">Контролирующий орган:</label>
